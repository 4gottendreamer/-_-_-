...
namespace lab_15_v6
{
	class lab_15_v6
	{
		...
		static bool MainMenu()
		{
			...
			Console.WriteLine("2. Лабораторная №05.\n   Работа с линейными массивами. Циклы.\n");
			Console.WriteLine("3. Лабораторная №06.\n"
				+ "   Работа с линейными массивами. Выборка, сортировка.\n");
				...
				bool ChoiceMenu()
				{
					...
					case "1": {
						Console.WriteLine("Введите количество элементов массива.\n" +
							"Внимание! При значениях больше 20 вычисление факториала\n" +
							"вызывает переполнение типа UInt64.");
		...
		/// <summary>
		/// Меняяет местами попарно слова в строках текста.
		/// </summary>
		/// <param name="_Text">Массив строк, составляющих текст</param>
		/// <returns>Массив строк изменённого текста</returns>
