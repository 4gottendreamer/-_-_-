...
//	instanceCount++;				 // увеличивается на 1
//}
//
...
//	/*...*/
//
//	// Комплексоное сопряжение
//	Complex conjugate()
//	{
//		return Complex(Re, -Im);
//	}
//
//	// Перегрузка оператора побитовой инверсии
//	// в качестве оператора комплексного сопряжения
//	Complex& operator~()
//	{
//		Im *= -1.f;
//		return *this;
//	}
//
//	bool operator and(Complex& _Rhs)
//	{
//		return Re > _Rhs.Re;
//	}
//
...
//	{
//		std::cout << Re;
//		if (Im < 0) { std::cout << " - " << -1.f * Im << " i"; }
//		else {
//			std::cout << " + " << Im << " i";
//		}
//	}
//
//	Complex operator*(const Complex& _Rhs);
//	Complex operator*(const double& _Rhs);
//
//	friend std::ostream& operator<<(std::ostream& _outStream, const Complex& _Z);
//	Complex& operator++();
//	// В параметры передаётся объект класса
//	friend Complex operator!(const Complex& _Z);
//	// В параметры передаются левый и правый операнды оператора ==
//	friend bool operator==(const Complex& _Rhs, const Complex& _Lhs);
//	template<typename T>
...
//{
//	return Complex(
//		this->Re * _Rhs.Re - this->Im * _Rhs.Im,
//		this->Re * _Rhs.Im + this->Im * _Rhs.Re
//	);
//}
//
//Complex Complex::operator*(const double& _Rhs)
//{
//	return Complex(0, 0);
//}
//
...
//// поле Re содержит модуль
//// поле Im содержит аргумент
//Complex operator!(const Complex& _Z)
//{
//	double R = std::fabs(_Z.Re * _Z.Re + _Z.Im * _Z.Im);
//	double phi = std::atan(_Z.Im / _Z.Re);
//	return Complex(R, phi);
//}
//
//bool operator==(const Complex& _Rhs, const Complex& _Lhs)
//{
//	return ((_Rhs.Re == _Lhs.Re) & (_Rhs.Im == _Lhs.Im));
//}
//
//template<typename T>
...
//}
//
//std::ostream& operator<<(std::ostream& _outStream, const Complex& _Z)
//{
//	_outStream << _Z.Re;
//	if (_Z.Im < 0) { _outStream << " - " << -1.f * _Z.Im << " i"; }
//	else {
//		_outStream << " + " << _Z.Im << " i";
//	}
//	return _outStream;
//}
//
//int main_class_Complex()
//{
//	Complex Z(1.3f, -3.25f);
//	Complex W(Z);
//	Complex C(!W);
//
//	Z.print();
...
//	std::cout << "(W and Z) " << (W and Z) << std::endl;
